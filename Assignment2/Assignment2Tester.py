...
if __name__ == '__main__':
    try:
        ...
        Assignment1.loadRatings('ratings', '/home/user/Desktop/best_data.dat', con);
        ...
        Assignment2.RangeQuery(1.5, 3.5, con, "/home/user/Desktop/rangeResult.txt");
        #Assignment2.RangeQuery(1,4,con, "/home/user/Desktop/rangeResult.txt");

        # Calling PointQuery
        print "Performing Point Query"
        Assignment2.PointQuery(4.5, con, "/home/user/Desktop/pointResult.txt");
        #Assignment2.PointQuery(2,con, "/home/user/Desktop/pointResult.txt");
